...
const bodyParser = require("body-parser"); //esto está dentro de express, por eso no se tiene que instalar otra vez.
...
app.set('view engine', 'ejs'); //dice que el motor de vistas dentro de express es ejs
...
workItems.set('1', 'Tarea To Do list');
workItems.set('2', 'Revisar propuesta EPF');
